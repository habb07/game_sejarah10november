...
public class GamePanel implements ActionListener {
    ...
    Image creditShow = Toolkit.getDefaultToolkit().getImage("resources\\images\\others\\credit.gif");
    ...
    Image timeShow = Toolkit.getDefaultToolkit().getImage("resources\\images\\others\\time.gif");
    Image caShow = Toolkit.getDefaultToolkit().getImage("resources\\images\\others\\list.png");
    ...
    class MyRectangleJPanel extends JPanel implements Runnable {
        ...
        public void paint(Graphics graphics) {
            ...
            //Coin
            graphics2D.drawImage(coinShow, 30, 15, null);
            graphics2D.drawString(" = " + point, 65, 40);

            //Counter Timer
            graphics2D.drawImage(timeShow, 250, 15, null);
            graphics2D.drawString(" = " + (int) counter + " ", 285, 40);

            //C/A
            graphics2D.drawImage(caShow, 360, 15, null);
            graphics2D.drawString(" = " + ExamQuestion.correctAnsCount + "/5", 395, 40);

            //CGPA 
            graphics2D.drawImage(creditShow, 130, 15, this);
            graphics2D.drawString(" = " + ExamQuestion.credit, 165, 40);
