...
public class ExamQuestion extends JPanel {
    ...
    private JLabel dialog, quesWinSideImage, bgs;
    ...
    public void Pertanyaan1Exam() throws FileNotFoundException {

        file = new File("resources\\question\\Pertanyaan1.txt");

        this.sc = new Scanner(file);

    }

    public void Pertanyaan2Exam() throws FileNotFoundException {

        file = new File("resources\\question\\Pertanyaan2.txt");

        this.sc = new Scanner(file);

    }

    public void Pertanyaan3Exam() throws FileNotFoundException {

        file = new File("resources\\question\\Pertanyaan3.txt");

        this.sc = new Scanner(file);

    }

    public void Pertanyaan4Exam() throws FileNotFoundException {

        file = new File("resources\\question\\Pertanyaan4.txt");

        this.sc = new Scanner(file);

    }

    public void Pertanyaan5Exam() throws FileNotFoundException {

        file = new File("resources\\question\\Pertanyaan5.txt");
    ...
    public void CreateQuestionFrame() {
        ...
        frame = new JFrame("Jawab Pertanyaan!");
    ...
    private class OKListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (answer != null) {
                ...
                JOptionPane.showMessageDialog(null, "Kamu melewati soal");
                frame.setVisible(false);
            }
        }
