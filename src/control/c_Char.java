...
public class c_Char {
    ...
    private Image gambarpemain;
    private Image gambarbendera; 
    private Image gambarkarakter;  //variabel tampung gambar
    ...
    public c_Char(){
        gambarkarakter = new ImageIcon(getClass().getResource("karakter.png")).getImage();
//        gambaremak = new ImageIcon(getClass().getResource("emak emak.png")).getImage();
        gambarbendera = new ImageIcon(getClass().getResource("bendera.png")).getImage();
    ...
    public void paint(Graphics g) {
        ...
        g2d.drawImage(gambarkarakter, xchar, ychar, 100, 100, null);       //gambar karakter, 75 (ukuran)
//        g2d.drawImage(gambaremak, xemak, yemak, 100, 100, null);          //gambar emak, 75 (ukuran)
        g2d.drawImage(gambarbendera, xbendera, ybendera, 100, 100, null);          //gambar kunci, 75 (ukuran)
        g2d.dispose();
    }
    public void move() {
