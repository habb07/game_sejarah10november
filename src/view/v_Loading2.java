 ...
 * @author Habibullah
 */
public class v_Loading2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        gbr.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/loading2.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(v_Loading2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new v_Loading2().setVisible(true);
            }
        });
    }
